...
$(function(){
	...
	filterFunc["cat" + 0] = id => CD[id][YD.CATEGORY1] == "";
	Object.keys(YD._CATEGORIES).forEach((v, i) => {
		filterFunc["cat" + v] = (id) => CD[id][YD.CATEGORY1] == YD._CATEGORIES[v] || (CD[id][YD.CATEGORY2] != "" && CD[id][YD.CATEGORY2] == YD._CATEGORIES[v]);
	});
...
let table = new Tabulator("#example-table", config);
